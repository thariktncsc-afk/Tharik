            ...
            <div style="overflow-x:auto">
              <table style="width:100%;border-collapse:collapse;min-width:780px">
                  ...
                  <tr style="background:#F8FAFC">
                    ...
                    <th data-adjcol="cs" rowspan="2" style="padding:8px 5px;text-align:center;font-size:9px;font-weight:700;color:#7C3AED;border-bottom:1px solid #E2E8F0;border-right:1px solid #E2E8F0;background:#F3E8FF;width:52px">C.S<br>Cum.Short</th><!-- [+] -->
                ...
                <tfoot>
                  <tr style="background:#EFF6FF;font-weight:800">
                    ...
                    <td id="me-a-cs" data-adjcol="cs" style="padding:9px 4px;text-align:right;font-size:11px;color:#7C3AED;background:#F3E8FF;border-top:2px solid #BAE6FD">0.000</td><!-- [+] -->
              ...
              <table style="width:100%;border-collapse:collapse;min-width:780px">
                <thead>
                  ...
                  <tr style="background:#FFFBF5">
                    ...
                    <th data-adjcol="cs" rowspan="2" style="padding:8px 5px;text-align:center;font-size:9px;font-weight:700;color:#7C3AED;border-bottom:1px solid #FED7AA;border-right:1px solid #FED7AA;background:#F3E8FF;width:52px">C.S<br>Cum.Short</th><!-- [+] -->
                ...
                <tfoot>
                  <tr style="background:#FFF7ED;font-weight:800">
                    ...
                    <td id="me-b-cs" data-adjcol="cs" style="padding:9px 4px;text-align:right;font-size:11px;color:#7C3AED;background:#F3E8FF;border-top:2px solid #FED7AA">0.000</td><!-- [+] -->
