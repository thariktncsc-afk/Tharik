...
console.log('\nThe office sheet has a line for every card and every allotment');
{
  ...
  // Which post the name and signature lines name — B.C, P.K.R, both or
  // neither — is decided per shop by the users table, and is checked in
  // tools/verify-staff-posts.mjs, preview, print and Excel.
